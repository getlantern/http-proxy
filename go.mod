...
require (
	...
	github.com/getlantern/quicwrapper v0.0.0-20200116041745-587fbed819e6
...
replace github.com/lucas-clemente/quic-go => github.com/getlantern/quic-go v0.0.0-20200110040505-6e02a255c65c
