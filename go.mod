...
require (
	...
	github.com/getlantern/httpstreams v0.0.0-20221024172328-95b4f9b755d5
...
replace github.com/lucas-clemente/quic-go => github.com/getlantern/quic-go v0.29.1-0.20221006143134-68f54fffde2f
