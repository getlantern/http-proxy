...
var (
	...
	domainList                   = flag.String("domainlist", "", "Whitelisted domains, such as the config server, pro server, etc, that should not count towards the bandwidth cap or be throttled, separated by comma")
)
