...
func (m *shadowsocksMetrics) AddClosedTCPConnection(clientLocation, accessKey, status string, data metrics.ProxyMetrics, timeToCipher, duration time.Duration) {
...
func (m *shadowsocksMetrics) AddTCPProbe(status, drainResult string, port int, data metrics.ProxyMetrics) {
